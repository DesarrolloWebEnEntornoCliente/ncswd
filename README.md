...
* [Original Design Overview](http://www.johnlovett.com/test.htm)
* [Designing for the Web](http://designingfortheweb.co.uk/)
* [A Guide in Making a Web Design Workflow](http://naldzgraphics.net/design-2/web-design-workflow-guide/)
* [Mathematics and Web Design: A Close Relationship](http://webdesign.tutsplus.com/articles/design-theory/mathematics-and-web-design-a-close-relationship/)
...
* [Learn FrontEnt Testing](https://github.com/FormidableLabs/learn-frontend-testing.git)
* [FrontEnd Developer Questions](https://github.com/h5bp/Front-end-Developer-Interview-Questions)
...
* [Inkscape](http://www.inkscape.org/es/)
...
* [All-Shilhouettes](http://all-silhouettes.com/)
* [CoolVectors](http://coolvectors.com/)
* [Designers](Revolution http://www.designers-revolution.com/portfolios/free-vectors/)
* [Dezignus](http://dezignus.com/category/vector/)
* [Flaticon](http://www.flaticon.com/)
* [FreeIconsWeb](http://www.freeiconsweb.com/)
* [Free Logo Types](http://www.free-logotypes.com/)
* [FreeVectors](http://freevectors.net/)
* [FreeVectors](http://www.freevectors.com/)
* [Free vector packs](http://www.smashingmagazine.com/2009/01/16/the-ultimate-collection-of-free-vector-packs/)
* [Logo Templater](http://www.logotemplater.com/)
* [QVectors](http://qvectors.net/)
* [Snap2objects](http://www.snap2objects.com/category/freebies/)
* [Spoon Graphics](http://blog.spoongraphics.co.uk/category/freebies)
* [Vecteezy](http://www.vecteezy.com/)
* [Vector4Free](http://vector4free.com/)
* [Vector Portal](http://www.vectorportal.com/)
* [Vector Valley](http://www.vectorvalley.com/)
* [Vector Vault](http://www.vectorvault.com/)

#### Templates ####

* [960 Grid System](http://960.gs/)
* [A detailed look at the 960GS framework](https://code.tutsplus.com/articles/a-detailed-look-at-the-960-css-framework--net-2567)
* [CSS Zen Garden](http://csszengarden.com/)
* [Free CSS Templates](http://www.freecsstemplates.org/)
* [Standard Screen Patterns](http://www.theresaneil.com/files/standard_screen_patterns.pdf)
* [Templatemo](http://www.templatemo.com/)

#### Colors ####

* [Colour Loves](http://www.colourlovers.com/)
* [Colour Palettes](http://pinterest.com/manekibeader/inspirational-colour-palettes/)
* [Color Schemer](http://www.colorschemer.com/online.html)
* [Colorzilla](http://www.colorzilla.com/)
* [HSL Picker](http://hslpicker.com/)
* [Paletton](http://paletton.com/)
* [On-line color test challenge](http://www.xrite.com/online-color-test-challenge)

#### Text and Fonts ####

* [Blind Text Generator](http://www.blindtextgenerator.com/es)
* [Fillerati](http://www.fillerati.com/)
* [Lorem Ipsum](http://es.lipsum.com/)
* [Choosing web fonts](http://www.creativebloq.com/web-design/choose-web-fonts-1233034)
* [50 best free fonts for designers](http://www.creativebloq.com/graphic-design-tips/best-free-fonts-for-designers-1233380)
...
* [The Leage of Moveable Type](https://www.theleagueofmoveabletype.com)
...
* [Multimedia over IP](http://www.cse.wustl.edu/~jain/cis788-97/ftp/ip_multimedia/#rsvp)
...
* [HTTP State Management Mechanism](http://tools.ietf.org/rfc/rfc6265.txt)
* [HTTP/1.1](http://tools.ietf.org/rfc/rfc2616.txt)
...
* [Document Cookies](https://developer.mozilla.org/en-US/docs/Web/API/document.cookie)
* [Directive 2002/58/EC](http://eur-lex.europa.eu/LexUriServ/LexUriServ.do?uri=CELEX:32002L0058:EN:HTML)
* [The Cookie Law explained](https://www.cookielaw.org/the-cookie-law/)
* [The stupid cookie law in 2½ minutes](https://www.youtube.com/watch?v=arWJA0jVPAc&amp;feature=youtu.be)
...
* [Document Type Declarations](http://www.w3.org/QA/2002/04/valid-dtd-list.html)
...
* [Media Events en HTML5](http://www.w3.org/2010/05/video/mediaevents.html)
* [HTMLMediaElement](https://developer.mozilla.org/en/docs/Web/API/HTMLMediaElement)
* [getUserMedia API](https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia)
* [Canvas API](https://developer.mozilla.org/en-US/docs/Web/API/Canvas_API)
* [Web Audio API](https://www.w3.org/TR/webaudio/)
* [Demos of HTML5 tecnologies](https://developer.mozilla.org/en-US/docs/Web/Demos_of_open_web_technologies)
...
* [Table creation assistant](http://www.somacon.com/p141.php)

#### Forms ####

* [button label](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button)
* [datalist label](https://developer.mozilla.org/en/docs/Web/HTML/Element/datalist)
* [form label](https://developer.mozilla.org/en/docs/Web/HTML/Element/form)
* [fieldset label](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/fieldset)
* [input label](https://developer.mozilla.org/en/docs/Web/HTML/Element/Input)
* [label label](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/label)
* [legend label](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/legend)
* [option label](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/option)
* [optgroup label](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/optgroup)
* [output label](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/output)
* [select label](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/select)
* [textarea label](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea)
* [20+ HTML Forms Best Practices](https://code.tutsplus.com/tutorials/20-html-forms-best-practices-for-beginners--net-6593)
...
* [Validator.nu Living Validator](http://validator.nu/)
...
* [Microdata standard](https://html.spec.whatwg.org/multipage/microdata.html)
* [schema.org using microdata](https://schema.org/docs/gs.html)
* [RDFa](https://rdfa.info/)
* [HTML+RDFa](https://www.w3.org/TR/html-rdfa/)
* [JSON-LD](http://json-ld.org/)
* [Microdata generator](http://microdatagenerator.com/)
* [Schema creator](https://hallanalysis.com/json-ld-generator/)
* [The Ultimate Microdata Generator](http://webcodetools.com/microdata-generator)
...
* [The link element](https://www.w3.org/TR/html5/document-metadata.html#the-link-element)
* [link vs import](http://www.stevesouders.com/blog/2009/04/09/dont-use-import/)
* [Cascading and Inheritance](http://www.w3.org/TR/css3-cascade/)
* [CSS Specifity, things you should know](https://www.smashingmagazine.com/2007/07/css-specificity-things-you-should-know/)
* [Selectors Level 4](https://www.w3.org/TR/selectors4/)
* [SMACSS](https://smacss.com/)
* [Colours](http://www.w3.org/TR/css3-color/)

#### CSS Reset ####

* [CSS Reset](http://www.cssreset.com/)
* [Yahoo's Developer Reset](http://developer.yahoo.com/yui/reset/)
* [MeyerWeb](http://meyerweb.com/eric/tools/css/reset/index.html)
* [Normalize.css](http://necolas.github.io/normalize.css/)
* [Create your own CSS Reset](http://net.tutsplus.com/tutorials/html-css-techniques/weekend-quick-tip-create-your-own-resetcss-file/)

#### Preprocessors ####

* [Dive into CSS Preprocessors](http://www.slideshare.net/verekia/deep-dive-into-css-preprocessors)
* [CSS Preprocessors](http://www.slideshare.net/patricka1/css-preprocessors-sass-less-and-stylus?next_slideshow=1)
* [{less}](http://lesscss.org/)
* [Bourbon](http://bourbon.io/)
* [Less Elements](http://lesselements.com/)
* [Less Mixins](http://www.sitepoint.com/a-comprehensive-introduction-to-less-mixins/)
...
* [The mystery of the float property](http://coding.smashingmagazine.com/2009/10/19/the-mystery-of-css-float-property/)
...
* [Units](http://www.w3.org/Style/Examples/007/units.en.html)
* [Modal CSS](https://github.com/pedrolaxe/modalcss)
...
* [Vertical align usign transforms](http://zerosixthree.se/vertical-align-anything-with-just-3-lines-of-css/)
...
* [20 CSS tips &amp; tricks](http://ajaxian.com/archives/20-css-tips-tricks)
...
* [CSS Triangle](http://codepen.io/chriscoyier/pen/lotjh)
...
* [mini.css](http://imperavi.com/kube/](Kube)[http://minicss.org/)
* [Picnic CSS](http://montagestudio.com/montagejs/](MontageJS)[http://picnicss.com/)
...
* [Dolphin](http://dolphin.com/)
* [Google Chrome](https://www.google.com/intl/es/chrome/browser/?hl=e)
...
* [WebGL Report](http://webglreport.sourceforge.net/)

##### Rendering engines and modes #####

* [Blink](http://www.chromium.org/blink)
* [EdgeHTML](https://en.wikipedia.org/wiki/EdgeHTML)
* [Gecko](https://developer.mozilla.org/es/docs/Gecko)
* [Servo](https://servo.org/)
* [Trident - MSHTML](http://msdn.microsoft.com/en-us/library/aa741317.aspx)
* [Webkit](http://www.webkit.org/)
* [Picking a rendering mode](http://www.ericmeyeroncss.com/bonus/render-mode.html)
* [Quirks mode and standard mode](https://developer.mozilla.org/es/docs/Quirks_Mode_and_Standards_Mode)

##### Aplication execution #####

* [MIME RFC2046](https://tools.ietf.org/html/rfc2046)
...
* [Introduction to Application Cache](http://www.html5rocks.com/en/tutorials/appcache/beginner/)
* [Offline.js](http://github.hubspot.com/offline/docs/welcome/)

##### DOM #####

* [DOM Levels](http://www.w3.org/DOM/DOMTR)
* [What does your user agent claim to support?](https://www.w3.org/2003/02/06-dom-support.html)
...
* [Raster Graphics Editors](https://en.wikipedia.org/wiki/Comparison_of_raster_graphics_editors)
* [ConvertICO](http://www.convertico.com/)
* [Free Online Photo Editor](http://www.freeonlinephotoeditor.com/)
* [Gimp](http://www.gimp.org/)
* [Liquid Rescale Gimp Plugin](http://liquidrescale.wikidot.com/)
* [NoJPEG](http://nojpeg.org/nojpeges.html#/)
* [Placehold.it](http://placehold.it/)
* [Progressive image renderings](http://blog.codinghorror.com/progressive-image-rendering/)
...
* [Core HTML5 Canvas examples](http://corehtml5canvas.com/code-live/)
...
* [jMyCarousel](http://www.enova-tech.net/eng/lab/jmycarousel/1)
* [Lightbox](http://lokeshdhakar.com/projects/lightbox2/)
* [ResponsiveSlides.js](http://responsiveslides.com/)
* [D3](http://d3js.org/)
* [Fabric.js](http://fabricjs.com/)
* [GFX](https://github.com/maccman/gfx)
* [GoJS](http://gojs.net)
...
* [All about CSS Transitions](http://www.kirupa.com/html5/all_about_css_transitions.htm)
* [All about CSS Animations](http://www.kirupa.com/html5/all_about_css_animations.htm)
* [3D Flip cards](http://css3playground.com/3d-flip-cards/)
* [CSS3 Animations CheatSheet](http://www.justinaguilar.com/animations/)
* [Cubic-bezier](http://tobiasahlin.com/spinkit/)
* [SpinKit](http://cubic-bezier.com/)
* [Picasion](http://gifmaker.me/)
* [GIF Maker](http://www.picasion.com/)
* [CSS Sprite Generator](http://spritegen.website-performance.org/)
* [Grumpicon](http://www.grumpicon.com/)
* [Sprite Cow](http://spritecow.com/)
...
* [Audio Editors](https://en.wikipedia.org/wiki/Comparison_of_digital_audio_editors)
* [Web audio examples](http://googlechrome.github.io/web-audio-samples/samples/audio/)
* [Getting started with Web Audio API](http://www.html5rocks.com/en/tutorials/webaudio/intro/)
* [aTube Catcher](http://atube-catcher.dsnetwb.com)
* [FFmpeg](http://ffmpeg.org/)
* [MiroVideoConverter](http://www.mirovideoconverter.com/)
* [Download videos](http://userscripts-mirror.org/scripts/show/25105)
* [videoconverter.js](http://bgrins.github.io/videoconverter.js/)
* [Free Studio](http://www.dvdvideosoft.com/es/free-dvd-video-software.htm)
...
* [Simple HTML5 Audio Player](http://jay-notes.blogspot.com.es/2010/06/simple-player-very-simple-html5-audio.html)
...
* [22 WebGL Demo Examples](http://www.awwwards.com/22-experimental-webgl-demo-examples.html)
* [WebGL Examples](http://www.khronos.org/webgl/)
* [Learning WebGL](http://learningwebgl.com/blog/)
* [Zygote Body](http://www.zygotebody.com/)

##### Libraries #####

* [divsugar](https://github.com/kitao/divsugar)
...
* [FreeStockPhotography](http://www.adigitaldreamer.com/gallery/index.php)
* [IgniteMotion](http://www.ignitemotion.com/)
* [morgueFile](http://morguefile.com/)
* [PickFindr](http://www.picfindr.com/)
* [PIXSY](http://www.pixsy.com/)
* [SoundBible](http://soundbible.com/)
* [stockvault.net](http://www.stockvault.net/)
* [freeimages](http://www.freeimages.com/)
* [Wikimedia Commons](http://commons.wikimedia.org/wiki/Main_Page?uselang=es)
...
* [ISO/IEC 9126-1](http://www.iso.org/iso/catalogue_detail.htm?csnumber=22749)
...
* [Adobe Edge Inspect CC](http://html.adobe.com/edge/inspect/)
...
* [Global Accesibility Awareness Day](http://globalaccessibilityawarenessday.org/)

#### Tips ####

* [10 Simple Web Accesibity Tips](http://sixrevisions.com/usabilityaccessibility/10-simple-web-accessibility-tips-you-can-do-today/)
...
* [Accessibility Features in Firefox](http://support.mozilla.org/en-US/kb/accessibility-features-firefox-make-firefox-and-we)
* [Fangs Screen Reader Emulator](https://addons.mozilla.org/es/firefox/addon/fangs-screen-reader-emulator/)
* [Accesibility Developer Tools](https://chrome.google.com/webstore/detail/accessibility-developer-t/fpkknkljclfencbdbgkenhalefipecmb)
* [Web Accesibility Toolbar for IE](http://www.paciellogroup.com/resources/wat)
...
* [Dolphin HAL](http://www.synapseadaptive.com/dolphin/hal.htm)
...
* [10 IaaS Providers](http://www.techrepublic.com/blog/10-things/10-iaas-providers-who-provide-free-cloud-resources/)
* [Cloud9](https://c9.io/)
* [Heroku](https://www.heroku.com)
* [Joyent Triton](http://www.joyent.com/)
* [Mozilla Thimble](https://thimble.mozilla.org/)
* [Pagoda Box](https://pagodabox.com/)
* [Pivotal](http://www.gopivotal.com/platform-as-a-service/pivotal-cf)
...
* [Microsoft VisualStudio](http://www.visualstudio.com/)
...
* [Fiddlesalad](http://fiddlesalad.com/)
...
* [web-make](http://www.vittoriozaccaria.net/wmake/)
...
* [Gerrit Code Review](http://git-scm.com/](Git)[https://www.gerritcodereview.com/)
...
* [Zombieexpect.js](http://zombie.js.org/)

##### Assertion Libraries #####

* [assert.js](https://github.com/Jxck/assert)
* [Chai](http://chaijs.com/)
* [expect.js](https://github.com/Automattic/expect.js)
* [jShould](https://github.com/eliperelman/jShould)
* [js-must](https://github.com/moll/js-must)
* [Should.js](https://github.com/shouldjs)
...
* [jslint4java](https://code.google.com/archive/p/jslint4java/)

#### Optimization, Compression, Obfuscation and Code Cleaners ####

* [Closure Tools](https://developers.google.com/closure/compiler/)
...
* [Functional JavaScript Workshop](https://github.com/timoxley/functional-javascript-workshop.git)
* [What the fuck JavaScript](https://github.com/brianleroux/wtfjs)
* [JavaScript Reference (MDN)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference)
* [JavaScript Reference (DevDocs)](http://devdocs.io/javascript/)

#### ECMAScript ####

* [The World of ECMAScript](http://ejohn.org/blog/the-world-of-ecmascript/)
* [ECMA-262 - ECMAScript 2015](http://www.ecma-international.org/ecma-262/6.0/ECMA-262.pdf)
...
* [JSC](https://code.google.com/p/v8/)
...
* [How to enable JavaScript in your browser](http://www.enable-javascript.com/)
* [Wirting JavaSCript for XHTML](https://developer.mozilla.org/en-US/docs/Writing_JavaScript_for_XHTML)

#### Transports and Document Origin Policies ####

* [SOP](https://www.w3.org/Security/wiki/Same_Origin_Policy)
* [CORS](http://www.w3.org/TR/cors)
* [Remote JSON - JSONP](http://bob.ippoli.to/archives/2005/12/05/remote-json-jsonp/)
...
* [Web Messaging](http://en.wikipedia.org/wiki/Web_Messaging)
* [CSRF Prevention Cheatsheet](https://www.owasp.org/index.php/CSRF_Prevention_Cheat_Sheet)

#### Asynchronous Execution ####

##### Pull (Ajax) #####

* [Article](http://adaptivepath.org/ideas/ajax-new-approach-web-applications/)
* [Why Ajax isn't enough](http://coding.smashingmagazine.com/2007/06/20/ajax-javascript-solutions-for-professional-coding/)
* [jQuery API for Ajax](http://api.jquery.com/category/ajax/)
* [jQuery Ajax](http://api.jquery.com/category/ajax/)
* [lleval Ajax service](http://colabv6.dan.co.jp/lleval.html)
* [XMLHttpRequest - Level 1](http://www.w3.org/TR/XMLHttpRequest/)
* [RestClient for Mozilla Firefox](https://addons.mozilla.org/es/firefox/addon/restclient/)

##### Push (Comet) #####

* [Article](http://infrequently.org/2006/03/comet-low-latency-data-for-the-browser/)
...
* [W3C JavaScript Best Practices](http://www.w3.org/wiki/JavaScript_best_practices)
* [15+ Best Practices for writing code](http://code.tutsplus.com/tutorials/top-15-best-practices-for-writing-super-readable-code--net-8118)
...
* [A Tao of Regular Expressions](http://www.let.uu.nl/%7EMichael.Moortgat/personal/Courses/TT02/tao_regexps.html)
* [Regular Expressions Tool](http://www.regexr.com/)
* [RegExr](http://erik.eae.net/playground/regexp/regexp.html)
...
* [11 ways to invoke a function in JavaScript](https://gist.github.com/myshov/05800f083a0afce56e0f782314a103eb)
...
* [Wikipedia article](http://en.wikipedia.org/wiki/List_of_JavaScript_libraries)
...
* [jQuery exercise](http://jqexercise.droppages.com/)
* [jQuery Learning Center](http://learn.jquery.com/)
* [Try jQuery](http://try.jquery.com)
* [FireQuery](http://firequery.binaryage.com/)
* [jQuery bookmarklet](http://www.learningjquery.com/2009/04/better-stronger-safer-jquerify-bookmarklet)
...
* [fun.js](http://fogus.github.io/lemonad/)
...
* [cell](http://www.celljs.org/)

##### MVC #####

* [Wikipedia Article](https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93controller)
...
* [Wikipedia Article](https://en.wikipedia.org/wiki/Model_View_ViewModel)
* [Undertanding MVVM for JS developers](https://addyosmani.com/blog/understanding-mvvm-a-guide-for-javascript-developers/)
...
* [Javascript Quiz ES6](http://perfectionkills.com/javascript-quiz-es6/)
...
* [Mozilla Persona](https://developer.mozilla.org/es/docs/Persona)
* [OAuth](http://oauth.net/)
* [OpenID](http://openid.net/)
* [SAML](https://en.wikipedia.org/wiki/Security_Assertion_Markup_Language)
* [XRI](http://es.wikipedia.org/wiki/Extensible_Resource_Identifier)
...
* [Gravatar for developers](https://en.gravatar.com/site/implement/)
* [LinkedIn for developers](http://developer.linkedin.com/)
...
* [¿Qué es la IPO?](http://www.desarrolloweb.com/articulos/1758.php)
* [Asociación Interacción Persona-Ordenador](http://aipo.es/)
* [Accesibilidad: Discapacidad en la Web - Parte 1](https://www.youtube.com/watch?v=mhLheLgGzxs)
* [Accesibilidad: Discapacidad en la Web - Parte 2](https://www.youtube.com/watch?v=PRo8-pfSoso)
* [Referencia de HTML en DevDocs](http://devdocs.io/html/)
* [Historia de HTML](http://idesweb.es/temario/historia-de-html)
* [No Solo Usabilidad](http://nosolousabilidad.com/)
* [https://www.youtube.com/watch?v=AQn22gjtSWQ&amp;index=2&amp;list=PLI7nHlOIIPOJtTDs1HVJABswW-xJcA7_o](Curso de JavaScript)
* [Introducción a CSS](http://librosweb.es/css/)
* [CSS avanzado](http://librosweb.es/css_avanzado/)
* [Curso de CSS de la W3C](http://www.w3.org/community/webed/wiki/CSS/Training)
* [Exposición del framework 960GS](http://idesweb.es/temario/frameworks-de-css)
* [Maquetación CSS con 960GS](http://www.desarrolloweb.com/manuales/maquetacion-css-960-grid-system.html)
* [Introducción a Canvas](http://diveintohtml5.info/canvas.html)
* [Lista de editores de vídeo](https://en.wikipedia.org/wiki/List_of_video_editing_software)
* [Ejercicios con jQuery](https://docs.google.com/document/d/1Jk_QBoRh1OaSqt88OXDiWKH-W6Sk9VJMQvW43QYUV-o/edit?pli=1)
* [Manual de Bootstrap 3](http://librosweb.es/bootstrap_3/)
* [Expresiones regulares: Conceptos básicos](https://www.youtube.com/watch?v=MbUyasEUOJI)
* [Expresiones regulares: sintaxis Perl/PCRE](https://www.youtube.com/watch?v=Xf4wvsnWNK0)
* [Introducción a Ajax](http://librosweb.es/ajax/)
* [Real Decreto-ley 13/2012](https://www.boe.es/buscar/pdf/2012/BOE-A-2012-4442-consolidado.pdf)
* [Frontazo](http://www.frontazo.com/)
* [Ejercicios sobre el DOM](http://librosweb.es/libro/javascript/capitulo_5/ejercicios_sobre_dom.html)
* [Diseño Web centrado en el usuario](http://www.upf.edu/hipertextnet/numero-2/diseno_web.html)
* [Galería de Media Queries](http://mediaqueri.es/)
* [Accesibilidad en la Web](http://accesibilidadenlaweb.blogspot.com.es/)
* [Accesibilidad web](http://accesibilidadweb.dlsi.ua.es/)
* [Accesibilidad web: Legislación en España](https://www.youtube.com/watch?v=6fAg6BVBHck)
